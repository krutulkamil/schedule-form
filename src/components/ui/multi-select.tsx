...
import { CheckIcon, XIcon, WandSparkles, ChevronsUpDown } from 'lucide-react';
      ...
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              'flex w-full p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto disabled:bg-neutral-100',
              className,
            )}
          >
